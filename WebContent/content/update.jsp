...
<body>
	...
	<div class="container">
		<div class="jumbotron">
			<div>
				<h1>Welcome to Online Student Updates</h1>
				<p>Its absolutely quick! Have a patient!</p>
			</div>
		</div>
	...
	<form id="myForm" method="get" class="bs-example form-horizontal"
		action="/StudentEnrollmentWithJDBC/StudentController?">


		<legend>Update Form</legend>
			
			<%System.out.println("tori laure value k ho k "+request.getAttribute("studentId") + request.getParameter("studentId"));   %>
		<input type="hidden" name="action" value="update">
		<input type="hidden" name="studentId" value=<%=request.getAttribute("studentId")%>>

		<%-- 						<p>	<center>	<div class="form-group"> --%>
				...
				<div class="modal-dialog">
					<div class="modal-content">
						<div class="modal-header">
							...
							<h3>Update your Form on Time</h3>
						</div>
						<div class="modal-body">
							<p>Are you sure you have updated fully</p>
							<div id="doitprogress" class="progress-bar"></div>
						</div>
						<div class="modal-footer">
							<a href="#" class="btn btn-default" data-dismiss="modal">Close</a>
							<input type="submit" value="Submit" id="yesbutton"
